...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20231113_laviedesplantes_ok_b8811b6d1a6681906732_20231113134857_archive.zip';
        const ARCHIVE_SIZE       = '77881088';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'b8811b6-13134857';
        const SECONDARY_PACKAGE_HASH = '2d9e208-13134857';
        const VERSION            = '1.5.7';
